(function (global, factory) {
    ...
    (global = global || self, factory(global.mostCore = {}, global.mostPrelude, global.mostScheduler, global.mostDisposable));
    ...
    ***************************************************************************** */
    ...
    var Empty = /** @class */ (function () {
        ...
        Empty.prototype.run = function (sink, scheduler$1) {
    ...
    var At = /** @class */ (function () {
        ...
        At.prototype.run = function (sink, scheduler$1) {
            return scheduler.delay(this.time, propagateTask(runAt, this.value, sink), scheduler$1);
        };
        return At;
    }());
    ...
    var Periodic = /** @class */ (function () {
        ...
        Periodic.prototype.run = function (sink, scheduler$1) {
            return scheduler.periodic(this.period, propagateEventTask(undefined, sink), scheduler$1);
        };
        return Periodic;
    }());
    ...
    /** @license MIT License (c) copyright 2010-2017 original author or authors */
    var runEffects = prelude.curry2(function (stream, scheduler) {
    ...
    var WithLocalTime = /** @class */ (function () {
        ...
        WithLocalTime.prototype.run = function (sink, scheduler$1) {
    ...
    var Scan = /** @class */ (function () {
        ...
        Scan.prototype.run = function (sink, scheduler$1) {
            var d1 = scheduler.asap(propagateEventTask(this.value, sink), scheduler$1);
    ...
    var ContinueWithSink = /** @class */ (function (_super) {
        ...
        function ContinueWithSink(f, source, sink, scheduler) {
            ...
            _this.active = true;
            _this.disposable = disposable.disposeOnce(source.run(_this, scheduler));
            return _this;
        }
    ...
    */
     ...
     */
    function ap(fs, xs) {
        return combine(prelude.apply, fs, xs);
    }

    /** @license MIT License (c) copyright 2010 original author or authors */
    var mergeConcurrently = function (concurrency, stream) {
        return mergeMapConcurrently(prelude.id, concurrency, stream);
    };
    ...
    var Outer = /** @class */ (function () {
        function Outer(f, concurrency, source, sink, scheduler) {
            ...
            this.pending = [];
            this.current = [];
            this.disposable = disposable.disposeOnce(source.run(this, scheduler));
            this.active = true;
        }
    ...
    var mapAndRun = function (f, t, x, sink, scheduler$1) {
    ...
    var mergeStreams = function (streams) {
        return streams.length === 0 ? empty()
            : streams.length === 1 ? streams[0]
                : new Merge(prelude.reduce(appendSources, [], streams));
    };
    ...
    */
    ...
    var Switch = /** @class */ (function () {
        ...
        Switch.prototype.run = function (sink, scheduler) {
            ...
            return disposable.disposeBoth(switchSink, this.source.run(switchSink, scheduler));
        };
        return Switch;
    }());
    var SwitchSink = /** @class */ (function () {
        ...
        SwitchSink.prototype.dispose = function () {
            return this.disposeCurrent(scheduler.currentTime(this.scheduler));
        };
    ...
    var Until = /** @class */ (function () {
        ...
        Until.prototype.run = function (sink, scheduler) {
            ...
            var d2 = this.maxSignal.run(new UntilSink(sink, disposable$1), scheduler);
    ...
    var Delay = /** @class */ (function () {
        ...
        Delay.prototype.run = function (sink, scheduler) {
            ...
            return disposable.disposeBoth(delaySink, this.source.run(delaySink, scheduler));
        };
        return Delay;
    }());
    var DelaySink = /** @class */ (function (_super) {
        ...
        DelaySink.prototype.event = function (_t, x) {
            this.tasks.push(scheduler.delay(this.dt, propagateEventTask(x, this.sink), this.scheduler));
        };
    ...
    var AwaitSink = /** @class */ (function () {
        function AwaitSink(sink, scheduler$1) {
            ...
            this.eventBound = function (x) { return _this.sink.event(scheduler.currentTime(_this.scheduler), x); };
            this.endBound = function () { return _this.sink.end(scheduler.currentTime(_this.scheduler)); };
            this.errorBound = function (e) { return _this.sink.error(scheduler.currentTime(_this.scheduler), e); };
            this.sink = sink;
    ...
    var ErrorStream = /** @class */ (function () {
        ...
        ErrorStream.prototype.run = function (sink, scheduler$1) {
            return scheduler.asap(propagateErrorTask(this.value, sink), scheduler$1);
        };
        return ErrorStream;
    }());
    ...
    var run$1 = prelude.curry3(run);
    var withLocalTime$1 = prelude.curry2(withLocalTime);
    var loop$1 = prelude.curry3(loop);
    var scan$1 = prelude.curry3(scan);
    var startWith$1 = prelude.curry2(startWith);
    var map$1 = prelude.curry2(map);
    var constant$1 = prelude.curry2(constant);
    var tap$1 = prelude.curry2(tap);
    var ap$1 = prelude.curry2(ap);
    var chain$1 = prelude.curry2(chain);
    var continueWith$1 = prelude.curry2(continueWith);
    var concatMap$1 = prelude.curry2(concatMap);
    var mergeConcurrently$1 = prelude.curry2(mergeConcurrently);
    var mergeMapConcurrently$1 = prelude.curry3(mergeMapConcurrently);
    var merge$1 = prelude.curry2(merge);
    var combine$1 = prelude.curry3(combine);
    var combineArray$1 = prelude.curry2(combineArray);
    var sample$1 = prelude.curry2(sample);
    var snapshot$1 = prelude.curry3(snapshot);
    var zipItems$1 = prelude.curry3(zipItems);
    var withItems$1 = prelude.curry2(withItems);
    var zip$1 = prelude.curry3(zip);
    var zipArray$1 = prelude.curry2(zipArray);
    var filter$1 = prelude.curry2(filter);
    var skipRepeatsWith$1 = prelude.curry2(skipRepeatsWith);
    var take$1 = prelude.curry2(take);
    var skip$1 = prelude.curry2(skip);
    var slice$1 = prelude.curry3(slice);
    var takeWhile$1 = prelude.curry2(takeWhile);
    var skipWhile$1 = prelude.curry2(skipWhile);
    var skipAfter$1 = prelude.curry2(skipAfter);
    var until$1 = prelude.curry2(until);
    var since$1 = prelude.curry2(since);
    var during$1 = prelude.curry2(during);
    var delay$1 = prelude.curry2(delay);
    var throttle$1 = prelude.curry2(throttle);
    var debounce$1 = prelude.curry2(debounce);
    var recoverWith$1 = prelude.curry2(recoverWith);
    var propagateTask$1 = prelude.curry3(propagateTask);
    var propagateEventTask$1 = prelude.curry2(propagateEventTask);
    var propagateErrorTask$1 = prelude.curry2(propagateErrorTask);
